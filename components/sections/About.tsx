      ...
      <motion.div className="flex justify-center lg:justify-start"
        ...
        <div className="relative overflow-visible">
          <div className="w-[200px] h-[260px] overflow-hidden relative"
            ...
            <Image src="/assets/nikulkumar-goyani.jpg" alt="Nikulkumar Goyani – Senior Software Test Engineer and V&V Expert, Chemnitz, Germany" width={200} height={260} className="object-cover w-full h-full" />
